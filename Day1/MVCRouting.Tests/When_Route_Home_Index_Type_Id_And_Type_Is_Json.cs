...
namespace MVCRouting.Tests
{
    ...
    [Subject("Routing")]
    public class When_Route_Home_Index_Type_Id_And_Type_Is_Json
    {
        ...
        Establish that = () =>
        {
            ...
            httpContextMock.Setup(c => c.Request.AppRelativeCurrentExecutionFilePath).Returns("~/home/index/json/1");
        };
        ...
        It should_have_type_of_json_and_id_1 = () =>
        {
            routeData.Values["Type"].ShouldEqual("json");
